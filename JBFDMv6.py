...
total_time_resource=420

Bearing_number, Sm, Bearing_force, Dimensionless_Bearing_force, F_reference, attitude_angle, theta, z, P_solution, P_solution_filtered,iteration, rmse_relative_error = calculate_bearing_force(epsilon, phi, epsilon_dot, phi_dot, omega, Ld, Bearing_clearence, Bearing_radius, miu, Atmospheric_pressure, spacing, min_relative_error, relaxation_coefficient, max_iterations,0)

Bearing_number, Sm, Bearing_force, Dimensionless_Bearing_force, F_reference, attitude_angle, theta, z, P_solution, P_solution_filtered,iteration, rmse_relative_error=error_correction(absolute_error_force, relative_error_force, total_time_resource,
                      Bearing_force, calculate_bearing_force, epsilon, phi, epsilon_dot, phi_dot, omega, Ld, Bearing_clearence, Bearing_radius, miu, Atmospheric_pressure, spacing, min_relative_error, relaxation_coefficient, max_iterations,0)
